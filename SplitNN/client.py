...
class ConvNet1(torch.nn.Module):
    def __init__(self):
        ...
        self.layer3 = Tree(BasicBlock, 32, 64, level=1, stride=1)
        self.layer4 = Tree(BasicBlock, 64, 128, level=2, stride=2)
        self.layer5 = Tree(BasicBlock, 128, 256, level=2, stride=2)
        self.layer6 = Tree(BasicBlock, 256, 512, level=1, stride=2)
